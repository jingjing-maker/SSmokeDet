...
sys.path.append(FILE.parents[3].as_posix())  
...
class WandbLogger():
       ...
       """
        ...
        if isinstance(opt.resume, str):  # checks resume from artifact
            ...
            self.wandb_run = wandb.init(config=opt,
                                        resume="allow",
                                        project='ssmokenet' if opt.project == 'runs/train' else Path(opt.project).stem,
                                        entity=opt.entity,
    ...
    def check_and_upload_dataset(self, opt):
        ...
        config_path = self.log_dataset_artifact(opt.data,
                                                opt.single_cls,
                                                'ssmokenet' if opt.project == 'runs/train' else Path(opt.project).stem)
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training ssmokenet models:
