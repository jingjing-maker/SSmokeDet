...
from SSmokeNet.utils import vis
from SSmokeNet.data.data_augment import preproc as preprocess
...
def make_parser():
    ...
    parser.add_argument("-n", "--name", type=str, default="SSmokeNet-s", help="model name")
...
def main(args):
    file_name = os.path.join("./SSmokeNet_outputs", args.name)
